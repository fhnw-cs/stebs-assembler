...
;
; Description:
; The array at addr C0 is sorted in ascending order.
;
...
; =========================================================================
Main:
    MOV   AL,C0   ; Set up array start address
    MOV   BL,06   ; Set up array size
...
Overflow:         ; Overflow due to compare
    ADD   CL,00   ; Test sign flag of array[addr]
    JNS   Swap    ; If not set: needs swapping
